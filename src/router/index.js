...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/admin/parks', name: 'adminParks', component: AdminParkList, meta: { requiresAdmin: true } },
    { path: '/admin/parks/:id', name: 'adminParkEditor', component: AdminParkEditor, meta: { requiresAdmin: true } },
  ]
})
